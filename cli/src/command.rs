...
impl SubstrateCli for Cli {
	...
	fn support_url() -> &'static str {
		"https://github.com/akropolisio/akropolisos-chain-node/issues/new"
	}
	...
	fn load_spec(&self, id: &str) -> std::result::Result<Box<dyn sc_service::ChainSpec>, String> {
		Ok(match id {
			...
			"syracuse" => Box::new(chain_spec::syracuse_testnet_config()?),
			"" | "akro" | "akropolisos" => Box::new(chain_spec::akropolisos_config()?),
