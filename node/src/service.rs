...
use akropolisos_runtime::{self, opaque::Block, RuntimeApi};
...
macro_rules! new_full_start {
    ($config:expr) => {{
        ...
        let builder = sc_service::ServiceBuilder::new_full::<
            akropolisos_runtime::opaque::Block,
    ...
    #[cfg(feature = "ocw")]
    {
        if let Some(seed) = dev_seed {
            service
                .keystore()
                .write()
                .insert_ephemeral_from_seed_by_type::<akropolisos_runtime::price_oracle::crypto::Pair>(
                    &seed,
                    akropolisos_runtime::price_oracle::KEY_TYPE,
                )
