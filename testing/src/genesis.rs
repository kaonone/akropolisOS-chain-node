...
use akropolisos_runtime::constants::currency::*;
use akropolisos_runtime::{
    AccountId, BalancesConfig, ContractsConfig, GenesisConfig,
    GrandpaConfig, IndicesConfig, SessionConfig, SocietyConfig, StakingConfig, SystemConfig,
...
pub fn config_endowed(
    ...
    GenesisConfig {
        ...
        bridge: None,
        dao: None,
        token: Some(TokenConfig { tokens: vec![Token {
			id: 0,
			decimals: 18,
